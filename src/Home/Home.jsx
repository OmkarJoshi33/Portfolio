          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 mt-8 justify-items-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="mt-2 text-lg text-gray-600">Core Java</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="mt-8 px-4 flex flex-col md:flex-row items-center justify-center gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="mt-2 text-lg text-gray-600">
                <strong>Email:</strong> omkarjoshi1231@gmail.com
              </p>
              ...
              <div className="flex gap-4 mt-4 justify-center md:justify-start">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-3xl text-gray-800 hover:text-blue-500 transition"
                >
                  <i className="fab fa-github"></i>
                </a>
                <a
                  href="https://www.linkedin.com/in/omkar-joshi-776477250/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-3xl text-gray-800 hover:text-blue-500 transition"
                >
